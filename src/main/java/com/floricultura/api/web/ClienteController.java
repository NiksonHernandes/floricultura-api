...
public class ClienteController {
    ...
    /**
     * CA-1: lista clientes paginados (default {@code pagina=0}, {@code tamanho=20}), com filtro opcional
     * {@code nome} ({@code ILIKE '%nome%'}). {@code tamanho} fora de {@code 1..100} ou {@code pagina < 0}
     * → 400 VALIDATION_ERROR. Itens com {@code produtoIds=null} (CA-3).
     *
     ...
     * {@code field} correspondente. Filtros combinam com <b>E</b> entre si e com {@code nome}.
     */
    @Operation(summary = "Lista clientes paginados com filtros (nome, comTelefone, comEmail) e "
    ...
    public ApiResponse<PaginaResponse<ClienteResponse>> listar(
        ...
        return ApiResponse.ok(clienteService.listar(pagina, tamanho, filtro), http.getRequestURI());
    }
