 ...
 * </ul>
 *
 * <p>Status/reset de senha ({@code PATCH .../status}, {@code .../senha}) e a regra do ultimo-admin
 * chegam no T-M1-5 (mesmos arquivos). Os {@link ExceptionHandler} <b>locais</b> (precedencia sobre o
 * {@code @RestControllerAdvice} do M0 — que <b>nao</b> e alterado, §8) dao as mensagens amigaveis de
 * 409/404. Nada de senha/hash em log (§9).
 */
@RestController
