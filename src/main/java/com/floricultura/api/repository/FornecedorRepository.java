...
/**
 * Acesso a persistencia de {@link Fornecedor} (SPEC-M5 §3.5) — irmao de {@code ClienteRepository}.
 * Desde o M6 (SPEC-M6 §3.7) a listagem paginada/filtrada/ordenada roda por
 * {@code findAll(Specification, Pageable)} do {@link JpaSpecificationExecutor}, com o predicado e o
 * {@code ORDER BY} vindos da {@link ContatoSpecs} — a derived query
 * {@code findByNomeContainingIgnoreCase} ficou sem chamador e foi removida. O {@code existsById}
